...
```
Error: locator.fill: Error: strict mode violation: getByPlaceholder('0.00') resolved to 2 elements:
    1) <input value="" type="number" placeholder="0.00" class="amount-input"/> aka getByPlaceholder('0.00').first()
    2) <input value="" type="number" placeholder="0.00" class="amount-input"/> aka getByPlaceholder('0.00').nth(1)
        ...
        - rowgroup [ref=e177]:
          - row "2804 Stationeries Stock In Hand (Office) Test Automation" [ref=e178]:
            ...
            - cell "Test Automation" [ref=e186]:
              - textbox "Description" [active] [ref=e187]: Test Automation
            - cell [ref=e188]:
              - spinbutton [ref=e190]
            - cell [ref=e191]:
              - spinbutton [ref=e193]
